...
public class UIAstronomy {
	...
	public int showMenu() {
		...
		System.out.println(
				...
				"(1) Para crear una galaxia \n" +
				"(2) Para mostrar la información de una galaxia \n" +
				"(3) Para crear o registrar un planeta \n" +
				"(4) Para mostrar la información de todas las galaxias\n"+
				"(0) Para salir"
				);
		option= sc.nextInt();
		sc.nextLine();
	...
	public void rf1CrearGalaxia() {
		System.out.println("Operación del RF1");
	}
